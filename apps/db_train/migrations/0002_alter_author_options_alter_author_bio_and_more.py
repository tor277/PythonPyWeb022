# Generated by Django 4.2.5 on 2024-03-26 17:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='author',
            name='self_esteem',
            field=models.DecimalField(blank=True, decimal_places=1, help_text="Введите уровень вашей самооценки, только честно! Градация от 0 до 5, где 0 - 'я молодец', 5 - 'я умница'", max_digits=2, null=True, validators=[django.core.validators.MinValueValidator(0, 'Диапозон [0.0, 5.0]'), django.core.validators.MaxValueValidator(5, 'Диапозон [0.0, 5.0]')], verbose_name='Уровень самооценки'),
        ),
        migrations.AlterField(
            model_name='author',
            name='status_rule',
